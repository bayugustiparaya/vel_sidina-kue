...
class MenungguTtdPolicy
{
    ...
    {
        return $user->can('view_any_surat::menunggu::ttd');
    }
    ...
    {
        return $user->can('view_surat::menunggu::ttd');
    }
    ...
    {
        return $user->can('create_surat::menunggu::ttd');
    }
    ...
    {
        return $user->can('update_surat::menunggu::ttd');
    }
    ...
    {
        return $user->can('delete_surat::menunggu::ttd');
    }
