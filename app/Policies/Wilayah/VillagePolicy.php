...
class VillagePolicy
{
    ...
    {
        return $user->can('view_any_wilayah::village');
    }
     ...
     *
     * @param  \App\Models\User  $user
     * @param  \App\Models\Wilayah\Village  $village
     * @return \Illuminate\Auth\Access\Response|bool
     */
    public function view(User $user, Village $village)
    {
        return $user->can('view_wilayah::village');
    }
    ...
    {
        return $user->can('create_wilayah::village');
    }
    ...
    {
        return $user->can('update_wilayah::village');
    }
    ...
    {
        return $user->can('delete_wilayah::village');
    }
