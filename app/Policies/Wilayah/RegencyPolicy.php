...
class RegencyPolicy
{
    ...
    {
        return $user->can('view_any_wilayah::regency');
    }
     ...
     *
     * @param  \App\Models\User  $user
     * @param  \App\Models\Wilayah\Regency  $regency
     * @return \Illuminate\Auth\Access\Response|bool
     */
    public function view(User $user, Regency $regency)
    {
        return $user->can('view_wilayah::regency');
    }
    ...
    {
        return $user->can('create_wilayah::regency');
    }
    ...
    {
        return $user->can('update_wilayah::regency');
    }
    ...
    {
        return $user->can('delete_wilayah::regency');
    }
     ...
     * @return \Illuminate\Auth\Access\Response|bool
     */
    public function replicate(User $user, Regency $regency)
    {
