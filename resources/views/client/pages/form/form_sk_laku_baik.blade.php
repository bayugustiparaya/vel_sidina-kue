...
<body>
    ...
    <div class="appHeader bg-primary text-light no-border">
        ...
        <div class="pageTitle">Permohonan SK Berkelakuan Baik</div>
        <div class="right"></div>
    </div>
    <!-- * App Header -->
        ...
        <div class="section mb-2 mt-2 full">
            <div class="wide-block pt-2 pb-2">
                <form action="app-components.html">
                    ...
                    <div class="form-group boxed">
                        <div class="input-wrapper">
                            <label class="label" for="name1">Status Perawinan</label>
                            <input type="text" class="form-control" id="name1" disabled>
                            <i class="clear-input">
                                <ion-icon name="close-circle"></ion-icon>
                            </i>
                    ...
                    <div class="form-group boxed">
                        <div class="input-wrapper">
                            <label class="label" for="name1">Alamat Domisili</label>
                            <input type="text" class="form-control" id="name1" placeholder="Masukkan Alamat Domisili Anda">
                            <i class="clear-input">
                                <ion-icon name="close-circle"></ion-icon>
                            </i>
                        </div>
