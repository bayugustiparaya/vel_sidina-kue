...
<body>
    ...
    <div class="appHeader bg-primary text-light no-border">
        ...
        <div class="pageTitle">Permohonan SK Meninggal Dunia</div>
        <div class="right"></div>
    </div>
    <!-- * App Header -->
        ...
        <div class="section mb-2 mt-2 full">
            <div class="wide-block pt-2 pb-2">
                <form action="app-components.html">
                    ...
                    <div class="form-group boxed">
                        <div class="input-wrapper">
                            <label class="label" for="name1">Tanggal Meninggal Dunia</label>
                            <input type="text" class="form-control" id="name1" disabled>
                            <i class="clear-input">
                                <ion-icon name="close-circle"></ion-icon>
                            </i>
                        ...
                        <div class="input-wrapper">
                            <label class="label" for="name1">Tempat Meninggal Dunia</label>
                            <input type="text" class="form-control" id="name1" disabled>
                            <i class="clear-input">
                                <ion-icon name="close-circle"></ion-icon>
                            </i>
                        ...
                        <div class="input-wrapper">
                            <label class="label" for="name1">Tanggal Dikebumikan</label>
                            <input type="text" class="form-control" id="name1" disabled>
                            <i class="clear-input">
                                <ion-icon name="close-circle"></ion-icon>
                            </i>
                        ...
                        <div class="input-wrapper">
                            <label class="label" for="name1">Tempat Dikebumikan</label>
                            <input type="text" class="form-control" id="name1" disabled>
                            <i class="clear-input">
                                <ion-icon name="close-circle"></ion-icon>
                            </i>
