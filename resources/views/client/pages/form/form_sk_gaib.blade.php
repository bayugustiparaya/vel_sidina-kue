...
<body>
    ...
    <div class="appHeader bg-primary text-light no-border">
        ...
        <div class="pageTitle">Permohonan Surat Keterangan Gaib</div>
        <div class="right"></div>
    </div>
    <!-- * App Header -->
            ...
            <div class="wide-block pt-2 pb-2">
                <form action="app-components.html">
                    ...
                    <div class="form-group boxed" id="formayah1">
                        <label for="formayah1">Data Orang Gaib</label>
                    ...
                    <div class="form-group boxed">
                        <div class="input-wrapper">
                            <label class="label" for="name1">Umur</label>
                    ...
                    <!-- Data Orang Yang Berhubungan Dengan Orang Gaib -->
                    <div class="form-group boxed" id="formibu1">
                        <label for="formibu1">Orang yang Berhubungan Keluarga</label>
                        <div class="input-wrapper">
                            <label class="label" for="nik">Nama</label>
                            <input type="text" class="form-control" id="nik" disabled>
                            <i class="clear-input">
                    ...
                    <div class="form-group boxed">
                        <div class="input-wrapper">
                            <label class="label" for="name1">Tahun Gaib</label>
                            <input type="text" class="form-control" id="name1" disabled>
                            <i class="clear-input">
                                <ion-icon name="close-circle"></ion-icon>
                            </i>
